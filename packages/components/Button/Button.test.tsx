/*
 * @Date: 2024-07-02 13:41:28
 * @LastEditors: xiaolong.su@bst.ai
 * @LastEditTime: 2024-07-02 14:06:21
 * @Description: 
 */
...
describe("Button.vue", () => {
  ...
  it("should has the correct type class when type prop is set", () => {
    ...
    types.forEach((type) => {
      ...
      expect(wrapper.classes()).toContain(`bst-button--${type}`);
    });
  });
  ...
  it("should has the correct size class when size prop is set", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(wrapper.classes()).toContain(`bst-button--${size}`);
    });
  });
